...
module.exports = {
   ...
   execute: async (client, message, args, prefix, guild, color, channel) => {
        let embed = new MessageEmbed()
            ...
            .setDescription(`pokerush Is a New Generation Pokemon Bot With Various Features which will make discord a better place and make pokemon fans enjoy playing pokemon even in discord. 
To Check Out The Other Commands Type : 
\`${prefix}help\` command.\nLike this: \`${prefix}help 2\`\n\n${client.user.username}'s Support Server: https://discord.gg/Ey6YfbcGzU`)
