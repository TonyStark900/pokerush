...
module.exports = {
  ...
  execute: async (client, message, args, prefix, guild, color, channel) => {
    ...
    let embed9 = new MessageEmbed()
      ...
      .addField("Redeem - Winner of tournaments/200 shards", `Get any Spawnable Pokémon of your choice.\n\`${prefix}redeem pokemon name\``)
      ...
      .setColor(color)
      .setFooter("Shards are premium currency and can be obtained by participating in tournament.")
