...
let Alolan = require('../db/alolans.js')
...
//Mention and respond
  ...
  if ([`<@${client.user.id}>`, `<@!${client.user.id}>`].includes(message.content) && !args[0]) {
    let embed = new MessageEmbed()
      ...
      .addField("Invite The Bot", `**[Click Here!](https://discord.com/api/oauth2/authorize?client_id=681241406311891001&permissions=8&scope=bot%20applications.commands)**`)
      .addField("Support Server:", `**[Click Here!](https://discord.gg/Ey6YfbcGzU)**`)
      .setColor(color)
...
//Blacklist and Suspend
  ...
  if (message.content.startsWith(guild.prefix.toLowerCase()) && guild.blacklist == true) return message.channel.send(">  **This server has been blacklisted. Join support server to appeal. https://discord.gg/Ey6YfbcGzU**");



  if (user && user.blacklist == true && message.content.toLowerCase().startsWith(guild.prefix)) return message.channel.send(">  **You have been blacklisted. Join support server to appeal. https://discord.gg/Ey6YfbcGzU**");
